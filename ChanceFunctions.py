...
def lovecalculator(split_message):
  embedVar = discord.Embed(title=":heart: Love Compability:heart: ",description=f'{split_message[1]} and {split_message[2]} are {random.randrange(100)}% compatible with each other:heart: ',color=0x00ff00)
  return embedVar
...
def askchance(split_message):
  ...
  chancestring="Chances of"+chancestring+" is "+str(random.randrange(100))+"%"
  print(chancestring)
  return chancestring
